...
namespace CommandAPI.Tests
{
    public class CommandsControllerTests : IDisposable
    {
        ...
        public void GetCommandItems_Returns200OK_WhenDBIsEmpty()
        {
            //Arrange            
            mockRepo.Setup(repo =>
            repo.GetAllCommands()).Returns(mockdata.GetCommands(0));
        ...
        public void GetCommandItems_Returns200OK_WhenDBHasOneResource()
        {
            //Arrange 
            mockRepo.Setup(repo =>
            repo.GetAllCommands()).Returns(mockdata.GetCommands(1));
        ...
        public void GetCommandByID_Returns404NotFound_WhenNonExistentIDProvided()
        {
            ...
            mockRepo.Setup(repo =>
            repo.GetCommandById(0)).Returns(mockdata.GetCommandByID(5));
        ...
        public void GetCommandByID_Returns200OK__WhenValidIDProvided()
        {
            ...
            mockRepo.Setup(repo =>
            repo.GetCommandById(1)).Returns(mockdata.GetCommandByID(1));
        ...
        public void GetCommandByID_ReturnsCorrectResourceType__WhenValidIDProvided()
        {
            ...
            var controller = new CommandsController(mockRepo.Object, mapper);
            //Act
            var result = controller.GetCommandById(5);
            //Assert
